...
/**
 * ClassFileWriter A ClassFileWriter is used to write a Java class file. Methods
 * are provided to create fields and methods, and within methods to write Java
 * bytecodes.
 * 
...
public class ClassFileWriter {
	...
	/**
	 * Add an interface implemented by this class. This method may be called
	 * multiple times for classes that implement multiple interfaces.
	 * 
	 * @param interfaceName
	...
	public static final short ACC_PUBLIC = 0x0001, ACC_PRIVATE = 0x0002,
			...
			ACC_TRANSIENT = 0x0080, ACC_NATIVE = 0x0100, ACC_ABSTRACT = 0x0400;

	/**
	 * Set the class's flags. Flags must be a set of the following flags,
	 * bitwise or'd together: ACC_PUBLIC ACC_PRIVATE ACC_PROTECTED ACC_FINAL
	 * ACC_ABSTRACT TODO: check that this is the appropriate set
	 * 
	 * @param flags
	...
	/**
	 * Add a method and begin adding code. This method must be called before
	 * other methods for adding code, exception tables, etc. can be invoked.
	 * 
	 * @param methodName
	...
	/**
	 * Complete generation of the method. After this method is called, no more
	 * code can be added to the method begun with <code>startMethod</code>.
	 * 
	 * @param maxLocals
	 ...
	 * ByteCode.SWAP: case ByteCode.WIDE: return 0; case ByteCode.ALOAD: case
	 * ByteCode.ASTORE: case ByteCode.BIPUSH: case ByteCode.DLOAD: case
	 * ByteCode.DSTORE: case ByteCode.FLOAD: case ByteCode.FSTORE: case
	 * ByteCode.ILOAD: case ByteCode.ISTORE: case ByteCode.LDC: case
	 * ByteCode.LLOAD: case ByteCode.LSTORE: case ByteCode.NEWARRAY: case
	 * ByteCode.RET: return 1; case ByteCode.ANEWARRAY: case ByteCode.CHECKCAST:
	 * case ByteCode.GETFIELD: case ByteCode.GETSTATIC: case ByteCode.GOTO: case
	 * ByteCode.IFEQ: case ByteCode.IFGE: case ByteCode.IFGT: case
	 * ByteCode.IFLE: case ByteCode.IFLT: case ByteCode.IFNE: case
	 * ByteCode.IFNONNULL: case ByteCode.IFNULL: case ByteCode.IF_ACMPEQ: case
	 * ByteCode.IF_ACMPNE: case ByteCode.IF_ICMPEQ: case ByteCode.IF_ICMPGE:
	 * case ByteCode.IF_ICMPGT: case ByteCode.IF_ICMPLE: case
	 ...
	 * ByteCode.PUTSTATIC: case ByteCode.SIPUSH: return 2; case
	 * ByteCode.MULTIANEWARRAY: return 3; case ByteCode.GOTO_W: case
	 * ByteCode.JSR_W: return 4; case ByteCode.LOOKUPSWITCH: // depends on
	 * alignment case ByteCode.TABLESWITCH: // depends on alignment return -1; }
	 * throw new IllegalArgumentException("Bad opcode: "+opcode); }
	 */
