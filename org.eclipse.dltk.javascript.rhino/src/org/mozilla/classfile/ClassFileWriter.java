...
public class ClassFileWriter
{
	...
	/**
	 * Set the class's flags. Flags must be a set of the following flags, bitwise
	 * or'd together: ACC_PUBLIC ACC_PRIVATE ACC_PROTECTED ACC_FINAL ACC_ABSTRACT
	...
	public void setTableSwitchJump(int switchStart, int caseIndex, int jumpTarget)
	{
		...
		if (!(0 <= switchStart && switchStart <= itsCodeBufferTop - 4 * 4 - padSize - 1)) { throw new IllegalArgumentException(
				switchStart + " is outside a possible range of tableswitch" + " in already generated code"); }
		if ((0xFF & itsCodeBuffer[switchStart]) != ByteCode.TABLESWITCH) { throw new IllegalArgumentException(switchStart
	...
	public void markLabel(int label)
	{
		...
		if (itsLabelTable[label] != -1) { throw new IllegalStateException("Can only mark label once"); }
	...
	private void fixLabelGotos()
	{
		...
		for (int i = 0; i < itsFixupTableTop; i++)
		{
			...
			if ((short) offset != offset) { throw new RuntimeException("Program too complex: too big jump offset"); }
	 ...
	 * does not take into account removal of this in case of non-static methods).
	 * If Java really supported references we wouldn't have to be this perverted.
	 */
	private static int sizeOfParameters(String pString)
	{
				...
				&& pString.charAt(0) == '(' && 1 <= rightParenthesis && rightParenthesis + 1 < length)
		{
			...
			if (ok)
			{
				...
				if (ok) { return ((count << 16) | (0xFFFF & stackDiff)); }
			}
		}
	 ...
	 * ByteCode.F2I: case ByteCode.F2L: case ByteCode.FADD: case ByteCode.FALOAD:
	 * case ByteCode.FASTORE: case ByteCode.FCMPG: case ByteCode.FCMPL: case
	 ...
	 * ByteCode.FSTORE_3: case ByteCode.FSUB: case ByteCode.I2B: case
	 * ByteCode.I2C: case ByteCode.I2D: case ByteCode.I2F: case ByteCode.I2L:
	 * case ByteCode.I2S: case ByteCode.IADD: case ByteCode.IALOAD: case
	 * ByteCode.IAND: case ByteCode.IASTORE: case ByteCode.ICONST_0: case
	 * ByteCode.ICONST_1: case ByteCode.ICONST_2: case ByteCode.ICONST_3: case
	 * ByteCode.ICONST_4: case ByteCode.ICONST_5: case ByteCode.ICONST_M1: case
	 * ByteCode.IDIV: case ByteCode.ILOAD_0: case ByteCode.ILOAD_1: case
	 * ByteCode.ILOAD_2: case ByteCode.ILOAD_3: case ByteCode.IMPDEP1: case
	 * ByteCode.IMPDEP2: case ByteCode.IMUL: case ByteCode.INEG: case
	 * ByteCode.IOR: case ByteCode.IREM: case ByteCode.IRETURN: case
	 * ByteCode.ISHL: case ByteCode.ISHR: case ByteCode.ISTORE_0: case
	 * ByteCode.ISTORE_1: case ByteCode.ISTORE_2: case ByteCode.ISTORE_3: case
	 * ByteCode.ISUB: case ByteCode.IUSHR: case ByteCode.IXOR: case ByteCode.L2D:
	 * case ByteCode.L2F: case ByteCode.L2I: case ByteCode.LADD: case
	 * ByteCode.LALOAD: case ByteCode.LAND: case ByteCode.LASTORE: case
	 * ByteCode.LCMP: case ByteCode.LCONST_0: case ByteCode.LCONST_1: case
	 * ByteCode.LDIV: case ByteCode.LLOAD_0: case ByteCode.LLOAD_1: case
	 * ByteCode.LLOAD_2: case ByteCode.LLOAD_3: case ByteCode.LMUL: case
	 * ByteCode.LNEG: case ByteCode.LOR: case ByteCode.LREM: case
	 * ByteCode.LRETURN: case ByteCode.LSHL: case ByteCode.LSHR: case
	 ...
	 * ByteCode.WIDE: return 0; case ByteCode.ALOAD: case ByteCode.ASTORE: case
	 * ByteCode.BIPUSH: case ByteCode.DLOAD: case ByteCode.DSTORE: case
	 * ByteCode.FLOAD: case ByteCode.FSTORE: case ByteCode.ILOAD: case
	 * ByteCode.ISTORE: case ByteCode.LDC: case ByteCode.LLOAD: case
	 * ByteCode.LSTORE: case ByteCode.NEWARRAY: case ByteCode.RET: return 1; case
	 * ByteCode.ANEWARRAY: case ByteCode.CHECKCAST: case ByteCode.GETFIELD: case
	 * ByteCode.GETSTATIC: case ByteCode.GOTO: case ByteCode.IFEQ: case
...
final class ConstantPool
{
	...
	boolean isUnderUtfEncodingLimit(String s)
	{
		...
		else if (strLen > MAX_UTF_ENCODING_SIZE) { return false; }
	...
	{
		if ((end - start) * 3 <= MAX_UTF_ENCODING_SIZE) { return end; }
	...
	short addUtf8(String k)
	{
		...
		if (theIndex == -1)
		{
			...
			if (tooBigString) { throw new IllegalArgumentException("Too big string"); }
		}
