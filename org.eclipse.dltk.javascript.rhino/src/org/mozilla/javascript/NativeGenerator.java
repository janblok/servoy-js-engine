...
public final class NativeGenerator extends IdScriptableObject {
	...
	public static final int GENERATOR_SEND = 0, GENERATOR_THROW = 1,
			GENERATOR_CLOSE = 2;
	...
	private static final int Id_close = 1, Id_next = 2, Id_send = 3,
			Id_throw = 4, Id___iterator__ = 5, MAX_PROTOTYPE_ID = 5;
