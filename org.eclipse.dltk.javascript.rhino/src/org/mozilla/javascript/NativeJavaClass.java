 ...
 * constructors and static members. We lazily reflect properties, and currently
 * do not guarantee that a single j.l.Class is only reflected once into the JS
 * environment, although we should. The only known case where multiple
 * reflections are possible occurs when a j.l.Class is wrapped as part of a
 * method return or property access, rather than by walking the Packages/java
 * tree.
 * 
 * @author Mike Shaver
 * @see NativeJavaArray
