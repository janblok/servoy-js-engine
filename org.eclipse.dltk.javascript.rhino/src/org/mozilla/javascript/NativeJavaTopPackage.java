...
public class NativeJavaTopPackage extends NativeJavaPackage implements Function, IdFunctionCall
{
	...
	private static final String commonPackages = "" + "java.lang;" + "java.lang.reflect;" + "java.io;" + "java.math;"
			+ "java.net;" + "java.util;" + "java.util.zip;" + "java.text;" + "java.text.resources;" + "java.applet;"
			+ "javax.swing;";
	...
	public Object execIdCall(IdFunctionObject f, Context cx, Scriptable scope, Scriptable thisObj, Object[] args)
	{
		if (f.hasTag(FTAG))
		{
			if (f.methodId() == Id_getClass) { return js_getClass(cx, scope, args); }
		}
		throw f.unknown();
	}
