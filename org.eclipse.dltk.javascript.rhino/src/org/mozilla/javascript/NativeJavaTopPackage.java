...
public class NativeJavaTopPackage extends NativeJavaPackage implements
		Function, IdFunctionCall {
	...
	public static void init(Context cx, Scriptable scope, boolean sealed) {
		...
		IdFunctionObject getClass = new IdFunctionObject(top, FTAG,
				Id_getClass, "getClass", 1, scope);
