 ...
 * and
 * {@link org.mozilla.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
 * when execution encounters a continuation captured by
 * {@link org.mozilla.javascript.Context#captureContinuation()}. Exception will
 * contain the captured state needed to restart the continuation with
...
public class ContinuationPending extends RuntimeException {
	...
	/**
	 * Construct a ContinuationPending exception. Internal call only; users of
	 * the API should get continuations created on their behalf by calling
	 * {@link org.mozilla.javascript.Context#executeScriptWithContinuations(Script, Scriptable)}
	 * and
	 * {@link org.mozilla.javascript.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
	 * 
	 * @param continuationState
	 *            Internal Continuation object
	 */
