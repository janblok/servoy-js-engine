...
/**
 * This class implements the object lookup required for the <code>with</code>
 * statement. It simply delegates every action to its prototype except for
 * operations on its parent.
 */
public class NativeWith implements Scriptable, IdFunctionCall, Serializable
{
	...
	public Object execIdCall(IdFunctionObject f, Context cx, Scriptable scope, Scriptable thisObj, Object[] args)
	{
		if (f.hasTag(FTAG))
		{
			if (f.methodId() == Id_constructor) { throw Context.reportRuntimeError1("msg.cant.call.indirect", "With"); }
		}
		throw f.unknown();
	}
	...
	static Object newWithSpecial(Context cx, Scriptable scope, Object[] args)
	{
		...
		thisObj.setPrototype(args.length == 0 ? ScriptableObject.getClassPrototype(scope, "Object") : ScriptRuntime
				.toObject(cx, scope, args[0]));
