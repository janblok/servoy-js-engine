...
public class BaseFunction extends IdScriptableObject implements Function {
	...
	private static final int Id_length = 1, Id_arity = 2, Id_name = 3,
			Id_prototype = 4, Id_arguments = 5,
	...
	protected void setInstanceIdValue(int id, Object value) {
		...
		case Id_prototype:
			if ((prototypePropertyAttributes & READONLY) == 0) {
				prototypeProperty = (value != null) ? value
	...
	public Object execIdCall(IdFunctionObject f, Context cx, Scriptable scope,
		...
		case Id_apply:
		case Id_call:
			return ScriptRuntime.applyOrCall(id == Id_apply, cx, scope,
					thisObj, args);
		...
		case Id_bind:
			...
			return new BoundFunction(cx, scope, targetFunction, boundThis,
					boundArgs);
		}
		throw new IllegalArgumentException(String.valueOf(id));
	}
	 ...
	 * create a new object itself. In this case {@link #construct} will set
	 * scope and prototype on the result {@link #call} unless they are already
	 * set.
	 */
	...
	private static Object jsConstructor(Context cx, Scriptable scope,
		...
		/*
		 * version != 1.2 Function constructor behavior - print 'anonymous' as
		 * the function name if the version (under which the function was
		 * compiled) is less than 1.2... or if it's greater than 1.2, because we
		 * need to be closer to ECMA.
		 */
	...
	private static final int Id_constructor = 1, Id_toString = 2,
			Id_toSource = 3, Id_apply = 4, Id_call = 5, Id_bind = 6,
