...
public class ObjArray implements Serializable {
	...
	public final void add(int index, Object value) {
		...
		default:
			ensureCapacity(N + 1);
			if (index != N) {
				System.arraycopy(data, index - FIELDS_STORE_SIZE, data, index
						- FIELDS_STORE_SIZE + 1, N - index);
			}
			data[index - FIELDS_STORE_SIZE] = value;
		}
		size = N + 1;
	...
	public final void remove(int index) {
		...
		default:
			if (index != N) {
				System.arraycopy(data, index - FIELDS_STORE_SIZE + 1, data,
						index - FIELDS_STORE_SIZE, N - index);
			}
			data[N - FIELDS_STORE_SIZE] = null;
		}
		size = N;
	...
	public final void toArray(Object[] array, int offset) {
		...
		switch (N) {
		default:
			System.arraycopy(data, 0, array, offset + FIELDS_STORE_SIZE, N
					- FIELDS_STORE_SIZE);
		case 5:
			array[offset + 4] = f4;
		case 4:
