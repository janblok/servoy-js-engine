...
public abstract class SecureCaller
{
	 ...
	 */
	static Object callSecurely(final CodeSource codeSource, Callable callable, Context cx, Scriptable scope,
				...
				try
				{
					...
					caller = (SecureCaller) AccessController.doPrivileged(new PrivilegedExceptionAction()
					{
						public Object run() throws Exception
						{
							...
							Class c = secCl.defineAndLinkClass(SecureCaller.class.getName() + "Impl",
	...
	private static byte[] loadBytecodePrivileged()
	{
		...
		try
		{
			...
			try
			{
				...
				{
					int r = in.read();
					if (r == -1) { return bout.toByteArray(); }
					bout.write(r);
				}
			}
			finally
