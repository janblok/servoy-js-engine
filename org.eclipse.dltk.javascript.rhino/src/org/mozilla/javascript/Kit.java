...
{
	/**
	 * Reflection of Throwable.initCause(Throwable) from JDK 1.4 or nul if it is
	 * not available.
	 */
	...
	/**
	 * Add <i>listener</i> to <i>bag</i> of listeners. The function does not
	 * modify <i>bag</i> and return a new collection containing <i>listener</i>
	 * and all listeners from <i>bag</i>. Bag without listeners always
	...
	/**
	 * Remove <i>listener</i> from <i>bag</i> of listeners. The function does
	 * not modify <i>bag</i> and return a new collection containing all
	 * listeners from <i>bag</i> except <i>listener</i>. If <i>bag</i> does
	 * not contain <i>listener</i>, the function returns <i>bag</i>.
	 * <p>
	 * For usage example, see {@link #addListener(Object bag, Object listener)}.
	 * 
	 * @param listener
	 *           Listener to remove from <i>bag</i>
	 * @param bag
	 *           Current collection of listeners.
	...
	{
		if (initialBufferCapacity <= 0) { throw new IllegalArgumentException("Bad initialBufferCapacity: "
