...
public class Context {
	 ...
	 * identifiers but warn about this usage. By default
	 * {@link #hasFeature(int)} returns false.
	 */
	 ...
	 * when the feature is on. By default {@link #hasFeature(int)} returns true.
	 */
	 ...
	 * {@link #call(ContextAction)} which guarantees proper association of
	 ...
	 * <p>
	 * It is allowed to use null for <tt>factory</tt> argument in which case the
	 * factory associated with the scope will be used to create new context
	 * instances.
	 * 
	 * @see ContextFactory#call(ContextAction)
	 */
	...
	/**
	 * Initialize the standard objects. Creates instances of the standard
	 * objects and their constructors (Object, String, Number, Date, etc.),
	 ...
	 * be considered experimental. The default implementation uses the
