...
public class Token {
	...
	// start enum
			...
			ENTERWITH = 2, LEAVEWITH = 3, RETURN = 4,
			GOTO = 5,
			IFEQ = 6,
			IFNE = 7, SETNAME = 8, BITOR = 9,
			BITXOR = 10,
			BITAND = 11,
			EQ = 12, NE = 13, LT = 14, LE = 15, GT = 16,
			GE = 17,
			LSH = 18,
			RSH = 19, URSH = 20, ADD = 21, SUB = 22,
			MUL = 23,
			DIV = 24,
			MOD = 25, NOT = 26, BITNOT = 27, POS = 28,
			NEG = 29,
			NEW = 30,
			DELPROP = 31,
			TYPEOF = 32,
			...
			CATCH_SCOPE = 56,
			ENUM_INIT_KEYS = 57,
			ENUM_INIT_VALUES = 58, ENUM_NEXT = 59,
			ENUM_ID = 60,
			THISFN = 61,
			RETURN_RESULT = 62, // to
								// return
	...
	HOOK = 98, // conditional (?:)
			...
			LABEL = 126, // label
			TARGET = 127, LOOP = 128, EXPR_VOID = 129, // expression statement
														// in
														// functions
