...
public class ScriptableOutputStream extends ObjectOutputStream
{
	 ...
	 * 
	 * @param name
	 *           a fully qualified name (of the form "a.b.c", where "a" must be a
	 *           property of the top-level object). The object need not exist, in
	 *           which case the name is ignored.
	...
	public void addOptionalExcludedName(String name)
	{
		...
		{
			if (!(obj instanceof Scriptable)) { throw new IllegalArgumentException("Object for excluded name " + name
					+ " is not a Scriptable, it is " + obj.getClass().getName()); }
			table.put(obj, name);
		}
	}
	...
	/**
	 * Adds the names of the standard objects and their prototypes to the list of
	 * excluded names.
	 */
	public void excludeStandardObjectNames()
	{
		String[] names = { "Object", "Object.prototype", "Function", "Function.prototype",
				"String",
				"String.prototype",
				"Math", // no Math.prototype
				"Array", "Array.prototype", "Error", "Error.prototype", "Number", "Number.prototype", "Date",
				"Date.prototype", "RegExp", "RegExp.prototype", "Script", "Script.prototype", "Continuation",
