...
public interface ConstProperties {
	 ...
	 * <code>Scriptable.get</code>. A class that implements this method may
	 * choose to ignore calls to set certain properties, in which case those
	...
	/**
	 * Reserves a definition spot for a const. This will set up a definition of
	 * the const property, but set its value to undefined. The semantics of the
