...
public class FunctionNode extends ScriptOrFnNode {
	 ...
	 * function. The second is a function expression, which is a function
	 * appearing in an expression except for the third type, which is... The
	 * third type is a function expression where the expression is the top-level
	 * expression in an expression statement. The three types of functions have
	 * different treatment and must be distinquished.
	 */
