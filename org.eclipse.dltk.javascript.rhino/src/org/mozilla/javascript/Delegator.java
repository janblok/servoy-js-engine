...
public class Delegator implements Function
{
	...
	/**
	 * Create a new Delegator that forwards requests to a delegee Scriptable
	 * object.
	 * 
	 * @param obj
	 *           the delegee
	 ...
	 * <code>hint</code> parameter is null,
	 * <code>ScriptRuntime.ScriptableClass</code> or
	 * <code>ScriptRuntime.FunctionClass</code>. Instead the object itself is
	 * returned.
	 * 
	 * @param hint
	 *           the type hint
	...
	/**
	 * Note that if the <code>delegee</code> is <code>null</code>, this
	 * method creates a new instance of the Delegator itself rathert than
	 * forwarding the call to the <code>delegee</code>. This permits the use
	 * of Delegator prototypes.
	 * 
	 * @param cx
