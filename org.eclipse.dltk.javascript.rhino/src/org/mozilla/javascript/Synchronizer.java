 ...
 * <code>Synchronizer</code> constructor, e.g.
 ...
 * <code>this</code> object of its invocation.
 * 
 * The Rhino shell provides a short-cut for the creation of synchronized
 * methods: <code>sync(fun)</code> has the same effect as calling the above
 * constructor.
 * 
...
public class Synchronizer extends Delegator {
	...
	public Object call(Context cx, Scriptable scope, Scriptable thisObj,
		...
		synchronized (sync instanceof Wrapper ? ((Wrapper) sync).unwrap()
				: sync) {
