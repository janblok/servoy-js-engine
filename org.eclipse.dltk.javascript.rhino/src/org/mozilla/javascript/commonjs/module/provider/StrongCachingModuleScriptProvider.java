 ...
 * @version $Id: StrongCachingModuleScriptProvider.java,v 1.3 2011/04/07
 *          20:26:12 hannes%helma.at Exp $
 */
public class StrongCachingModuleScriptProvider extends
		CachingModuleScriptProviderBase {
	private static final long serialVersionUID = 1L;

	private final Map<String, CachedModuleScript> modules = new ConcurrentHashMap<String, CachedModuleScript>(
