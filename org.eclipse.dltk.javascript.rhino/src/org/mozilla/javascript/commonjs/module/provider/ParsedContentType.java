 ...
 * @version $Id: ParsedContentType.java,v 1.3 2011/04/07 20:26:12
 *          hannes%helma.at Exp $
 */
public final class ParsedContentType implements Serializable {
	 ...
	 * 
	 * @param mimeType
	 *            the full MIME type; typically the value of the "Content-Type"
	 *            header of some MIME-compliant message. Can be null.
	 */
