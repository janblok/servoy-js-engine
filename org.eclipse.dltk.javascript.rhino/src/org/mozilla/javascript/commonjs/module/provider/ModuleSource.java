 ...
 * security domain, and a cache validator. <h1>Cache validators<h1>. Validators
 * are used by caches subclasses from {@link CachingModuleScriptProviderBase} to
...
public class ModuleSource implements Serializable {
	 ...
	 *            source (passed to Rhino script compiler).
	 * @param uri
	 *            the URI of the module's source text
	 * @param validator
	 *            a validator that can be used for subsequent cache validation
	 *            of the source text.
	 */
	 ...
	 * the source text.
	 * 
	 * @return the validator that can be used for subsequent cache validation of
	 *         the source text.
	 */
