...
/**
 * The default heuristic for calculating cache expiry of URL-based resources. It
 * is simply configured with a default relative expiry, and each invocation of
 * {@link #calculateExpiry(URLConnection)} returns
 * {@link System#currentTimeMillis()} incremented with the relative expiry.
 * 
 * @author Attila Szegedi
 * @version $Id: DefaultUrlConnectionExpiryCalculator.java,v 1.3 2011/04/07
 *          20:26:12 hannes%helma.at Exp $
 */
public class DefaultUrlConnectionExpiryCalculator implements
		UrlConnectionExpiryCalculator, Serializable {
