 ...
 * @version $Id: RequireBuilder.java,v 1.4 2011/04/07 20:26:11 hannes%helma.at
 *          Exp $
 */
public class RequireBuilder implements Serializable {
	 ...
	 *            the module script provider for the {@link Require} instances
	 *            that this builder builds.
	...
	/**
	 * Sets whether the created require() instances will be sandboxed. See
	 * {@link Require#Require(Context, Scriptable, ModuleScriptProvider, Script, Script, boolean)}
	 * for explanation.
	 * 
	 * @param sandboxed
	 *            true if the created require() instances will be sandboxed.
	 * @return this, so you can chain ("fluidize") setter invocations
	 */
