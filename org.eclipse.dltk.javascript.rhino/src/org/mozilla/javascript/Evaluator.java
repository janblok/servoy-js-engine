...
public interface Evaluator {
	...
	/**
	 * Compile the script or function from intermediate representation tree into
	 * an executable form.
	 * 
	 * @param compilerEnv
	 ...
	 *            parse tree
	 * @param encodedSource
	 *            encoding of the source code for decompilation
	 ...
	 * @param bytecode
	 *            opaque object returned by compile
	 * @param staticSecurityDomain
	 *            security domain
	 ...
	 *            Context
	 * @param linep
	 *            Array object of length >= 1; getSourcePositionFromStack will
	...
	/**
	 * Mark the given script to indicate it was created by a call to eval() or
