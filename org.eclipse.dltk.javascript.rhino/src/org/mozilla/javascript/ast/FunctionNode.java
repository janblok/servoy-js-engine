...
public class FunctionNode extends ScriptNode {
	 ...
	 * 
	 * @return the function parameter list. Returns an immutable empty list if
	...
	/**
	 * Sets the function parameter list, and sets the parent for each element of
	 * the list.
	 * 
	 * @param params
	...
	/**
	 * Adds a parameter to the function parameter list. Sets the parent of the
	 * param node to this node.
	 * 
	 * @param param
	 *            the parameter
	 ...
	 * Function node. This provides a way during AST traversal to disambiguate
	 * the function name node from the parameter nodes.
	 */
	...
	/**
	 * Sets function body, and sets its parent to this node. Also sets the
	 * encoded source bounds based on the body bounds. Assumes the function node
	 * absolute position has already been set, and the body node's absolute
	 * position and length are set.
	 * <p>
	 * 
	 * @param body
	 ...
	 * {@link org.mozilla.javascript.NativeCall}, and is fairly expensive to
	 * create, so when possible, the interpreter attempts to use a plain call
	 * frame instead.
	 * 
	 * @return true if this function needs activation. It could be needed if
	 *         there is a lexical closure, or dynamic scope, or in a number of
	 *         other situations.
	 */
	 ...
	 * expression other than a simple Name in the position where a function name
	 * was expected, we record that expression here.
	 * <p>
	...
	/**
	 * Visits this node, the function name node if supplied, the parameters, and
	 * the body. If there is a member-expr node, it is visited last.
	 */
	@Override
