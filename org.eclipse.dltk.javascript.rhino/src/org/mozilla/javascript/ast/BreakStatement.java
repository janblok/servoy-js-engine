...
public class BreakStatement extends Jump {
	 ...
	 * 
	 * @return the break label. {@code null} if the source code did not specify
	 *         a specific break label via "break &lt;target&gt;".
	 */
	...
	/**
	 * Sets the intended label of this break statement, e.g. 'foo' in
	 * "break foo". Also sets the parent of the label to this node.
	 * 
	 * @param label
	 ...
	 * 
	 * @return the break target. Only {@code null} if the source code has an
	 *         error in it.
	 */
