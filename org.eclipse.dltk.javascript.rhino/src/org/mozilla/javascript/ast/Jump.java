...
/**
 * Used for code generation. During codegen, the AST is transformed into an
 * Intermediate Representation (IR) in which loops, ifs, switches and other
 * control-flow statements are rewritten as labeled jumps. If the parser is set
 * to IDE-mode, the resulting AST will not contain any instances of this class.
 */
public class Jump extends AstNode {
	...
	/**
	 * Jumps are only used directly during code generation, and do not support
	 * this interface.
	 * 
