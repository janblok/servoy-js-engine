...
public class NewExpression extends FunctionCall {
	...
	/**
	 * Sets initializer object. Rhino supports an experimental syntax of the
	 * form {@code new expr [ ( arglist ) ] [initializer]}, in which initializer
	 * is an object literal that is used to set additional properties on the
	 * newly-created {@code expr} object.
	 * 
	 * @param initializer
