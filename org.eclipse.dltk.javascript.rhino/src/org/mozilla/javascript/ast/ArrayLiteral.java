 ...
 * {@code null}, although the list will have no elements if the Array literal is
 * empty.
 * <p>
 * 
...
public class ArrayLiteral extends AstNode implements DestructuringForm {
	 ...
	 *             if element is {@code null}. To indicate an empty element, use
	 *             an {@link EmptyExpression} node.
	 */
	...
	/**
	 * Returns the number of elements in this {@code Array} literal, including
	 * empty elements.
	 */
	public int getSize() {
	 ...
	 * generator. {@code for ([a,] in obj)} is legal, but
	 * {@code for ([a] in obj)} is not since we have both key and value
	 * supplied. The difference is only meaningful in array literals used in
	 ...
	 * elements are represented by {@link EmptyExpression} objects, so the
	 * callback will never be passed {@code null}.
	 */
	@Override
