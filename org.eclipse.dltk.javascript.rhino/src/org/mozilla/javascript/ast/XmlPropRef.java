...
/**
 * AST node for an E4X XML {@code [expr]} property-ref expression. The node type
 * is {@link Token#REF_NAME}.
 * <p>
 * 
 * Syntax:
 * <p>
 * 
 * <pre>
 * @<i><sub>opt</sub></i> ns:: <i><sub>opt</sub></i> name
 * </pre>
 * 
