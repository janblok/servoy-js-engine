 ...
 * {@link AstNode} implementations that can introduce a new scope.
 */
public class Scope extends Jump {
	...
	/**
	 * Add a scope to our list of child scopes. Sets the child's parent scope to
	 * this scope.
	 * 
	 * @throws IllegalStateException
	 *             if the child's parent scope is non-{@code null}
	 */
	...
	/**
	 * Used by the parser; not intended for typical use. Changes the
	 * parent-scope links for this scope's child scopes to the specified new
	 * scope. Copies symbols from this scope into new scope.
	 * 
	 * @param newScope
	...
	/**
	 * Creates a new scope node, moving symbol table information from "scope" to
	 * the new node, and making "scope" a nested scope contained by the new
	 * node. Useful for injecting a new scope in a scope chain.
	 */
	 ...
	 *             if any non-{@code AstNode} objects are in the child list,
	 *             e.g. if this method is called after the code generator begins
