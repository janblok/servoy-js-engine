...
public class TryStatement extends AstNode {
	...
	/**
	 * Sets list of {@link CatchClause} nodes. Also sets their parents to this
	 * node. May be {@code null}. Replaces any existing catch clauses for this
	 * node.
	 */
	...
	/**
	 * Add a catch-clause to the end of the list, and sets its parent to this
	 * node.
	 * 
	 * @throws IllegalArgumentException
	...
	/**
	 * Visits this node, then the try-block, then any catch clauses, and then
	 * any finally block.
	 */
	@Override
