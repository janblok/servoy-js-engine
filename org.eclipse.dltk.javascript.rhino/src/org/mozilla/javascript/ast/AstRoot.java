...
public class AstRoot extends ScriptNode {
	 ...
	 * comments are not visited by the {@link #visit} function - you must use
	 * this function to visit them.
	 * 
	 * @param visitor
	 *            the callback object. It is passed each comment node. The
	...
	/**
	 * Visits the AST nodes, then the comment nodes. This method is equivalent
	 * to calling {@link #visit}, then {@link #visitComments}. The return value
	...
	/**
	 * Debugging function to check that the parser has set the parent link for
