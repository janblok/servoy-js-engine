 ...
 * 
 * <p>
 * The first three should be familiar to Java programmers. JsDoc comments are
 * really just block comments with some conventions about the formatting within
 * the comment delimiters. Line and block comments are described in the Ecma-262
 * specification.
 * <p>
 * 
 * <p>
 * SpiderMonkey and Rhino also support HTML comment syntax, but somewhat
 ...
 * parent, but Comments are always stored directly in the AstRoot node, so they
 * are also effectively absolute offsets.
 */
public class Comment extends AstNode {
	 ...
	 *            the start position
	 * @param len
	 *            the length including delimiter(s)
	 * @param type
	 *            the comment type
	 * @param value
	 *            the value of the comment, as a string
	 */
	...
	/**
	 * Comment nodes are not visited during normal visitor traversals, but
	 * comply with the {@link AstNode#visit} interface.
	 */
	@Override
