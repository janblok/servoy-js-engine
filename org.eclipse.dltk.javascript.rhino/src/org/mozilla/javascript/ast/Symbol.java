...
public class Symbol {
	 ...
	 * 
	 * @param declType
	 *            {@link Token#FUNCTION}, {@link Token#LP} (for params),
	 *            {@link Token#VAR}, {@link Token#LET} or {@link Token#CONST}
	 */
	...
	public void setDeclType(int declType) {
		if (!(declType == Token.FUNCTION || declType == Token.LP
				|| declType == Token.VAR || declType == Token.LET || declType == Token.CONST))
